  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
      <div class="col-md-9 pb-5">
        <p class="breadcrumbs">
          <a href="{{ route('home') }}">Anasayfa <i class="ion-ios-arrow-forward"></i></a></span> <span>Blog <i class="ion-ios-arrow-forward"></i></span>
        </p>
        ...
        <div class="col-md-4 mb-4">
          <div class="car-wrap rounded">
            <div class="img rounded d-flex align-items-end"
              style="background-image: url('{{ asset('storage/' . ($car->images->first()->path ?? 'default.jpg')) }}');">
            </div>
            <div class="text">
              <h2 class="mb-0">
              ...
              <p class="d-flex mb-0 d-block">
                <a href="https://wa.me/{{ setting('whatsapp') }}?text={{ urlencode('Aracı kiralamak istiyorum: ' . route('car.show', $car->id)) }}"
                  class="btn btn-primary py-2 mr-1">Rezervasyon</a>
                <a href="{{ route('car.show', $car->id) }}" class="btn btn-secondary py-2 ml-1">Detay</a>
              </p>
            </div>
          </div>
        </div>
